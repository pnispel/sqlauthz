import { Permission, SQLActor, SQLFunction, SQLGroup, SQLProcedure, SQLRowLevelSecurityPolicy, SQLSchema, SQLSequence, SQLTableMetadata, SQLUser, SQLView } from "./sql.js";
...
export interface SQLBackendContext {
    ...
    removeAllPermissionsFromActorsQueries: (users: SQLActor[], entities: SQLEntities) => string[];
